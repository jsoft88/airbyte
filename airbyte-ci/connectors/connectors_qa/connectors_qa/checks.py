...
class ValidateMetadata(Check):
    ...
    required_env_vars = {consts.DOCKER_HUB_USERNAME_ENV_VAR_NAME, consts.DOCKER_HUB_PASSWORD_ENV_VAR_NAME}
...
class CheckVersionFollowsSemver(Check):
    ...
    def _run(self) -> CheckResult:
        ...
        return self.create_check_result(passed=True, message="Connector version follows semantic versioning")
